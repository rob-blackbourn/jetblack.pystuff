...
class RomanDate(object):
    ...
    def toordinal(self):
        ...
        return ({Event.Kalends: JulianDate(self.year, self.month, 1).toordinal(),
                 Event.Nones:   JulianDate(self.year, self.month, self.nones_of_month(self.month)).toordinal(),
                 Event.Ides:    JulianDate(self.year, self.month, self.ides_of_month(self.month)).toordinal()
                 }[self.event] -
                self.count +
    ...
    def fromordinal(cls, ordinal):
        ...
        kalends1 = RomanDate(year_prime, month_prime, Event.Kalends, 1, False).toordinal()
